    ...
    <>
        ...
        <div className="container-fluid">
            ...
            <form className="d-flex">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-search" viewBox="0 0 16 16" style={{ transform: 'translateX(-10px)',cursor: 'pointer' }}>
